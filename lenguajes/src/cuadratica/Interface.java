...
public class Interface extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        float vala=Float.parseFloat(a.getText());
        float valb=Float.parseFloat(b.getText());
        float valc=Float.parseFloat(c.getText());
        EcCuad ec=new EcCuad();
        ec.setA(vala);
        ec.setB(valb);
        ec.setC(valc);
